...
* **General**: we measure precision by summing up all the True Positives (TP) of all resources, and dividing by the sum of TP and False Positives (FP) for all resources. For recall we divide by the sum of TP and False negative (FN) for all resources.
